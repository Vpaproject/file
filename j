...
myOpenVPNconf1
 cat <<'myOpenVPNconf3' > /etc/openvpn/server_ec.conf
# KinGmapua
port MyOvpnPort3
proto tcp
dev tun
...
EOF122
 ...
 sed -i "s|MyOvpnPort3|$OpenVPN_Port3|g" /etc/openvpn/server_ec.conf
 ...
 systemctl start openvpn@server_ec
 systemctl enable openvpn@server_tcp
 systemctl enable openvpn@server_udp
 systemctl enable openvpn@server_ec
 systemctl restart openvpn@server_tcp
 systemctl restart openvpn@server_udp
 systemctl restart openvpn@server_ec
